...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "phase-1-development-only-key-change-me")
if not DEBUG and SECRET_KEY == "phase-1-development-only-key-change-me":
...
# Conservative defaults for a local development foundation. Deployment-specific
